"""Authoring a fused kernel for a detected region, with Xe-Fuse as one executor
among several rather than a hard dependency. Design rationale: docs/DESIGN.md."""
...
class FusionExecutor(StrEnum):
    ...
    # Agent-authored SYCL operator override; default, needs only a compiler.
    AUTHOR = "author"
    # Xe-Fuse's autotuned templates, when installed and the region matches a preset.
    XE_FUSE = "xe_fuse"
...
class FusionTask:
    ...
    def describe(self) -> str:
        ...
        lines += [
            ...
            "    dispatch key so nothing in the framework is forked.",
