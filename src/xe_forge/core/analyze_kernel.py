...
def print_analysis(analysis: Dict, filepath: Path):
    ...
    if analysis["kernel_type"] == "gemm":
        print("Suggested Template: templates/gemm_template.py")
    elif analysis["kernel_type"] == "gemm_epilogue":
        print("Suggested Template: templates/gemm_epilogue_template.py")
    elif analysis["kernel_type"] in ["reduction", "gemm_reduction"]:
        print("Suggested Template: templates/reduction_template.py")
    print()
